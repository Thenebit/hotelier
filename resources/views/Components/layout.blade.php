                ...
                <div class="h-16 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="relative" id="currency-selector">
                            <button class="flex items-center space-x-1 text-gray-700 cursor-pointer">
                                <span>GHS</span>
                                <i class="ri-arrow-down-s-line"></i>
                            </button>
                            <div class="hidden absolute top-full right-0 mt-2 w-32 bg-white rounded shadow-lg py-2 custom-scrollbar">
                                <div class="cursor-pointer px-4 py-2 hover:bg-gray-100" onclick="selectCurrency('USD')">USD</div>
                                <div class="cursor-pointer px-4 py-2 hover:bg-gray-100" onclick="selectCurrency('GHS')">GHS</div>
                            </div>
                        </div>
                ...
                <div class="container mx-auto px-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        <div class="h-[400px] rounded-lg overflow-hidden">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3968.0876865861745!2d-0.3716893!3d6.0947475!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf7e9e8c2cc3ed%3A0x3e1c0f6b3f8d6868!2sKoforidua%20Technical%20University!5e0!3m2!1sen!2sgh!4v1699387742010!5m2!1sen!2sgh" class="w-full h-full border-0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                        <div>
